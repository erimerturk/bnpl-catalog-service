...
import com.bnpl.catalogservice.domain.PropertyAlreadyExistsException;
...
public class PropertyControllerAdvice {
    ...
    String NotFoundHandler(PropertyNotFoundException ex) {
        return ex.getMessage();
    }

    @ExceptionHandler(PropertyAlreadyExistsException.class)
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    String alreadyExistsHandler(PropertyAlreadyExistsException ex) {
        return ex.getMessage();
    }
